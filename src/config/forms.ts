// URLs for the embedded Microsoft Forms submission forms.
// Leave a field `undefined` until the chairs have created the corresponding
// form and confirmed "Anyone with the link can respond" is enabled (see
